...
KNOWN_PROPERTIES = {
    ...
    "Written by me",
    "I used AI to polish my reviews",
    "Relevant",
    "Available",
    "Open",
    "Fresh",
    ...
    "Usable (OPTIONAL)",
    #"Quality score",
    "Suitable for a long talk",
}
SKIPPED_PROPERTIES = {
    "Use of AI for review",
    "BOSC Acceptance Criteria",
        ...
        if "reviews" in submission and submission["reviews"]:
            for review in submission["reviews"]:
                score_summary = [
                    ...
                    f"I used AI to polish my reviews: {review['I used AI to polish my reviews']}",
                    f'Relevant: {review["Relevant"]}',
                    f'Available: {review["Available"]}',
                    f'Open: {review["Open"]}',
                    f'Fresh: {review["Fresh"]}',
                    f'AI use transparency: {review["AI use transparency"]}',
                    f'Community: {review["Community"]}',
                    f'Active: {review["Active"]}',
                    f'Novelty: {review["Novelty"]}',
                    f'Example: {review["Example"]}',
                    f'Usable: {review["Usable (OPTIONAL)"]}',
                    #f'Quality Score: {review["Quality score"]}',
                    f'Suitable for a long talk: {review["Suitable for a long talk"]}',
                ]
                score_summary_str = "\n\n".join(score_summary)
                ...
                remark_summary = [
                    ...
                    f'Fresh: {review["Fresh remarks"]}',
                    f'AI use transparency: {review["AI use transparency remarks"]}',
                    f'Community: {review["Community remarks"]}',
                    f'Active: {review["Active remarks"]}',
                    f'Novelty: {review["Novelty remarks"]}',
                    f'Example: {review["Example remarks"]}',
                    f'Usable: {review["Usable (OPTIONAL) remarks"]}',
                    #f'Quality Score: {review["Quality score remarks"]}',
                    f'Suitable for a long talk: {review["Suitable for a long talk remarks"]}',
                ]
                remark_summary_str = "\n\n".join(remark_summary)
